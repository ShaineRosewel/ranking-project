...
\item
  ...
  alliance or ticket commonly co-occur in ballots.
\end{itemize}
...
\item
  ...
  parameter settings.
\item
  Compare the results of Algorithm 1 to Klein's joint confidence regions
  that uses Bonferroni and independence assumption, in terms of coverage
  and tightness measures.
\item
...
\phantomsection\label{correlation-structures}
\begin{itemize}[<+->]
\tightlist
\item
  This assumes that the \(k\) variables are equally correlated, i.e.,
  that \(\rho_{jk}=\rho\) where \(\rho \in [-1,1]\) for
  \(j \neq k \in \{1, \dots, K\}\). For the simulation we let
  \(\rho \in \{0.1, 0.5, 0.9\}\). \begin{equation}
...
\begin{frame}{Correlation Structures}
\phantomsection\label{correlation-structures-1}
\begin{table}[H]
\centering
...
\begin{frame}{Coverage of Unordered Parameters}
\phantomsection\label{coverage-of-unordered-parameters}
\begin{table}[H]
...
\begin{frame}{Coverage of Unordered Parameters}
\phantomsection\label{coverage-of-unordered-parameters-1}
\begin{table}[H]
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{9}{11}\selectfont
\begin{tabular}[t]{cccccccc}
...
\begin{frame}{Coverage of Unordered Parameters}
\phantomsection\label{coverage-of-unordered-parameters-2}
\begin{center}\includegraphics[width=0.95\linewidth]{../proposal_files/figure-latex/nonrank-cov-plot-1} \end{center}
\end{frame}

\begin{frame}{Tightness}
\phantomsection\label{tightness}
\centering
\begingroup
\fontsize{9}{11}\selectfont
...
\begin{frame}{Tightness}
\phantomsection\label{tightness-1}
\centering
\begingroup
\fontsize{9}{11}\selectfont
\setlength{\tabcolsep}{6pt}
...
\begin{frame}{Tightness Measure of Unordered Parameters}
\phantomsection\label{tightness-measure-of-unordered-parameters}
\begin{center}\includegraphics[width=1\linewidth]{../proposal_files/figure-latex/unnamed-chunk-24-1} \end{center}
\end{frame}

\begin{frame}{Coverage of Ordered Parameters}
\phantomsection\label{coverage-of-ordered-parameters}
\begin{center}\includegraphics[width=1\linewidth]{../proposal_files/figure-latex/extra-1} \end{center}
\end{frame}

\begin{frame}{Tightness Measure of Ordered Parameters}
\phantomsection\label{tightness-measure-of-ordered-parameters}
\begin{center}\includegraphics[width=1\linewidth]{../proposal_files/figure-latex/extra-ordered-t-1} \end{center}
\end{frame}

\begin{frame}{Application}
\phantomsection\label{application}
\begin{center}\includegraphics[width=0.635\linewidth]{../proposal_files/figure-latex/pulse-result-1} \end{center}
\end{frame}

\begin{frame}{Application}
\phantomsection\label{application-1}
\begin{center}\includegraphics[width=0.635\linewidth]{../proposal_files/figure-latex/travel-time-fig-nonrank-1} \end{center}
