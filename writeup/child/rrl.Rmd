...
The first one is adapted from Theorem 1 of @sidak which states that for a vector of random variables of dimension $K$ $\mathbf{X} = (X_1, X_2, \dots, X_K)$ with $X_k \sim N\left(0, \sigma_k \right)$ for $x = 1, \dots, K$ and having an arbitrary correlation matrix $R = \left\{ \rho_{ik} \right\}$,
