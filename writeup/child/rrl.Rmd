...
The study of @klein assumes that $\hat{\theta}_k\sim N(\theta_k,\sigma^2_k), k=1,2,\ldots,K$ where $\theta_k$ is unknown but $\sigma^2_k$ is known.  Their solution is premised on the fact that the uncertainty in the ranks is determined by uncertainty in the parameters (@mogstadt23). We now describe their methodology.
