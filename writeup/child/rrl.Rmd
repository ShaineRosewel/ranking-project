...
@klein used a set familiar individual confidence intervals of the form $\hat \theta_k \pm z_{\alpha/2} SE_k$. They assumed that $\hat \theta_1, \hat \theta_1, \dots, \hat \theta_K$ are independently distributed, with $\hat \theta_k \sim N(\theta_k, SE_k)$ for $k = 1, 2, \dots, K$, where $\theta_1, \theta_2, \dots \theta_k$ are unknown and $SE_1, SE_2, \dots, SE_k$ are known. It was noted that $SE_k = \frac{MOE_k}{z_{\alpha/2}}$. Two approaches were considered for constructing the joint confidence intervals: the Bonferroni correction and the independence assumption.
