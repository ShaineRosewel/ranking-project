...
Other studies with similar concern include that of @jelle where using the same assumptions, Tukey's pairwise comparison procedure is used to come up with their $\left( 1-\alpha \right)$ joint confidence intervals for ranks in  \ref{eq:jelle}. They showed this to yield uniformly narrower intervals than that of Klein's approach, for the case when $SE$s are equal.
