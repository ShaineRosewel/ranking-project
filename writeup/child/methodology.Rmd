...
## Joint confidence intervals for $\theta_1, \dots, \theta_K$ by using Parametric Bootstrap {#sec:parametricbs}
...
## Joint confidence intervals for $\theta_1, \dots, \theta_K$ by using Nonrank-based method {#sec:nonrankbased}
...
\begin{equation}
  ...
  \label{eq:t3}
\end{equation}
Higher values of $T_1$ and $T_2$ indicate wider confidence intervals and are therefore less desirable, whereas higher values of $T_3$ are preferable.
