The parametric bootstrap and nonrank-based method are introduced to calculate joint confidence regions to simultaneously quantify uncertainty. These are compared to current approaches from @klein: independent and Bonferroni. 
