...
\begin{algorithm}[H]
    \caption{Computation of Joint Confidence Region (Nonrank)} 
...
\begin{algorithm}[H]
    \caption{Computation of Joint Confidence Region (Asymptotic Variance)} 
...
\begin{algorithm}[H]
    \caption{Computation of Joint Confidence Region (Variance from Double Bootstrap)} 
