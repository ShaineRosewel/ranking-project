...
df$iso <- c('MD', 'NY', 'NJ', 'DC','IL', 'MA', 'VA', 'CA', 'GA', 'NH', 'PA', 'FL', 'HI', 'WV','WA', 'DE', 'CT', 'AZ', 'TX', 'CO','LA', 'TN', 'MI', 'NV', 'AL', 'MS', 'SC', 'IN', 'ME', 'NC', 'RI', 'MO', 'OH', 'MN', 'KY', 'OR', 'VI', 'WI', 'UT', 'NM', 'AR', 'OK', 'ID', 'KS', 'IA', 'AK', 'MT', 'NE', 'WY', 'ND', 'SD'  )

kde_result <- merge(x = df[,c('k', 'iso')], y = kde_result, by = "k", all.x = TRUE)
...
#ggsave("kde_ranks_plot.png", plot = p, width = 10, height = 8, dpi = 300)
p
```
