...
get_coverage <- function(dataset_or, 
  ...
  gamma = 1-(1-alpha)^(1/K)
  z1 = qnorm(gamma/2)
  result$ind_ci_lower <- means - z1*dataset$S
  result$ind_ci_upper <- means + z1*dataset$S
  ...
  z2 = qnorm((alpha/2)/2)
  result$bonf_ci_lower <- means - z2*dataset$S
  result$bonf_ci_upper <- means + z2*dataset$S
