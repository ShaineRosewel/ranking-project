...
# corr_matrix <-block_corr(block_sizes=c(2, 2, 8, 6), rho_within=c(0, 0.9, 0.9, 0.9), rho_between=0.0)
corr_matrix <-block_corr(block_sizes=c(27, 11, 2, 10, 12, 2), rho_within=c(0.0, 0.8, 0.8, 0.8, 0.8, 0.8), rho_between=0.0) # <- sample asymptotic neg rad
...
```{r}
process_ci_result(result = ci_results$nonrankbased, K=64)
```
