...
LOW <- list(CHAR = "Coverage", NAME = "Low",  TABNAME = "$\\\\text{Low } V(\\\\theta_k)$")
MED <- list(CHAR = "Coverage", NAME = "Moderate",  TABNAME = "$\\\\text{Moderate } V(\\\\theta_k)$")
HIGH <- list(CHAR = "Coverage", NAME = "High",  TABNAME = "$\\\\text{High } V(\\\\theta_k)$")
